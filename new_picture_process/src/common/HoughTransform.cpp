...
unsigned char * HoughTransform::lineDetectionI(unsigned char * bmp, int width, int height, int linebyte, int number)
{
...
unsigned char * HoughTransform::lineDetectionII(unsigned char * bmp, int width, int height, int linebyte, int number)
{
	unsigned char * pBmpBuf = new unsigned char[height*linebyte]{ 0 };
	for ( i = 0; i < height*linebyte; i++)
	{
